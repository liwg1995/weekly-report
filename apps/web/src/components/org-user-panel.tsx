...
export default function OrgUserPanel(props: Props) {
  return (
    <section style={{ border: "1px solid var(--border)", borderRadius: "12px", padding: "12px" }}>
      ...
      <form onSubmit={props.submitCreateUser} style={{ display: "grid", gap: "8px", marginBottom: "12px" }}>
        <input
      ...
      <form onSubmit={props.submitAssignDepartment} style={{ display: "grid", gap: "8px", marginBottom: "12px" }}>
      ...
      <form onSubmit={props.submitSetLeader} style={{ display: "grid", gap: "8px", marginBottom: "12px" }}>
